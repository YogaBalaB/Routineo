...
export default function HabitsPage() {
  ...
  const updateHabit = async (e?: FormEvent) => {
  ...
  const deleteHabit = async (id: string) => {
    setDeleteModal({ isOpen: true, habitId: id, isBulk: false });
  };
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 md:space-y-8 relative">
      ...
      <ConfirmModal 
        ...
        isLoading={isLoading}
        title={deleteModal.isBulk ? "Delete Multiple Habits?" : "Delete this habit?"}
        message={deleteModal.isBulk 
          ? `Are you sure you want to delete ${selectedHabitIds.length} habits? This cannot be undone.` 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <AnimatePresence mode="popLayout">
          ...
          {habits.map((habit) => {
            ...
            // Generate last 7 days for the heatmap
            ...
            return (
              ...
              >
                 {/* Options Menu - Enhanced Visibility */}
                 {!isEditing && (
                ...
                <div className="relative z-10">
                   <div className="flex items-start justify-between mb-4">
                       ...
                       <div className={cn("px-4 py-1.5 rounded-xl text-xs font-bold uppercase tracking-widest shadow-sm", categoryInfo.color)}>
                          {habit.category}
                       </div>
                   </div>
                      ...
                      <div className="bg-slate-50 p-4 rounded-3xl border border-neon-purple/20 space-y-4">
                         ...
                         />
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button type="button" onClick={() => deleteHabit(habit.id)} className="text-red-500 font-bold text-xs hover:text-red-600 transition-colors mr-2">Delete</button>
                            <PrimaryButton 
                            ...
                            <button 
                              ...
                              className="ml-2 px-4 py-2 rounded-xl border border-[#D1D5DB] text-[#6B7280] font-medium hover:border-[#9CA3AF] transition-colors text-xs"
                            >
                              Cancel
                            </button>
                         </div>
                       ...
                       <div className="flex flex-col">
                         <h3 className="text-2xl font-display font-bold text-dark-navy mt-4 mb-2 tracking-tight line-clamp-1">{habit.title}</h3>
